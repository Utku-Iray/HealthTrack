       ...
       <div class="row">
         ...
         <div class="col-md-3">
           <div class="useful-links">
             ...
             <div class="dilos">
               <button class="aytek" style="padding-left: 0px;">Tedaviler</button>
               <div class="dilos-content">
                 <a href="mobil-hizmetler.php">Mobil Hizmetler</a>
                 <a href="kisiye-ozel-analiz.php">Kişiye Özel Analiz</a>
                 <a href="butuncul-tip.php">Bütüncül Tıp</a>
                 <a href="iv-terapi.php">Iv Terapi</a>
                 <a href="nad.php">Nad Terapi</a>
                 <a href="beslenme-diyetetik.php">Beslenme Diyetetik</a>
                 <a href="psikoloji.php">Psikoloji</a>
                 <a href="kayropraktik.php">Kayropraktik</a>
                 <a href="ozon-terapi.php">Ozon Terapisi</a>
                 <a href="hormon-replasmani.php">Hormon Replasmanı</a>
                 <a href="gida-takviyeleri.php">Gıda Takviyeleri</a>
                 <a href="hemeopati.php">Hemeopati</a>
               </div>
             </div>
           </div>
         </div>
               ...
               <div class="get-touch">
                 ...
                 <ul>
                   <li>
                     ...
                     <p style="color: white; line-height:17px;">Dikilitaş mah. Hakkı Yeten cad. Selenium Plaza No: 101/19 12. Kat Fulya Beşiktaş İSTANBUL
                     </p>
                   </li>
                   <li>
                     <i class="icon-phone4"></i>
                     <a href="tel:05438400220">+90 543 840 02 20</a>
                   </li>
                   <li>
                     <a href="#."><i class="icon-dollar"></i>
                       <a href="mailto:info@healthtrack.com.tr">info@healthtrack.com.tr</a></a>
                   </li>
                 </ul>
               </div>
             </div>
