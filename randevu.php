...
include 'header.php';
?>
<div style="display: flex;justify-content: center;align-items: center;position: fixed;bottom: 30px;left: 30px;z-index: 999999;-webkit-animation: pulse 1.25s infinite cubic-bezier(0.66, 0, 0, 1);-moz-animation: pulse 1.25s infinite cubic-bezier(0.66, 0, 0, 1);-ms-animation: pulse 1.25s infinite cubic-bezier(0.66, 0, 0, 1);animation: pulse 1.25s infinite cubic-bezier(0.66, 0, 0, 1);">

<a target="_blank" href="https://api.whatsapp.com/send?phone=905434510405&amp;text=Hi!"><svg style="pointer-events:none;display:block;height: 70px;width: 70px;" width="50px" height="50px" viewBox="0 0 1024 1024">
		<defs>
...
<div class="sub-banner">
	...
	<img class="banner-img" src="images/randevu.jpg" alt="">
	<div class="detail">
		<div class="container">
			<div class="row">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="main-title text-center">
						<h2><span>Randevu</span> İşlemleri</h2>
