        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="get-touch">
              <ul>
                <li>
                  <a href="tel:05438400220"><i class="icon-phone4"></i>+90 543 840 02 20</a>
                </li>
                <li>
                  <a href="mailto:info@healthtrack.com.tr"><i class="icon-mail"></i> info@healthtrack.com.tr</a>
                </li>
              </ul>
                ...
                <li class="parent">
                  ...
                  <ul class="submenu">
                    <li class="parent">
                      ...
                      <!-- <ul class="submenu">
                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
                    ...
                    <li class="parent">
                      <a href="beslenme-diyetetik.php">Beslenme ve Diyetetik</a>
                      <!-- <i class="icon-chevron-small-right"></i>  -->
                      <!-- <ul class="submenu">
                                                                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
                    ...
                    <li class="parent">
                      <a href="ozon-terapi.php">Ozon Terapi</a>
                      <!-- <i class="icon-chevron-small-right"></i>  -->
                      <!-- <ul class="submenu">
                                                                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
                    ...
                    <li class="parent">
                      <a href="hormon-replasman.php">Hormon Replasmanı</a>
                      <!-- <i class="icon-chevron-small-right"></i>  -->
                      <!-- <ul class="submenu">
                                                                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
                    ...
                    <li class="parent">
                      <a href="hemeopati.php">Homeopati</a>
                      <!-- <i class="icon-chevron-small-right"></i>  -->
                      <!-- <ul class="submenu">
                                                                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
        ...
        <nav id="menu">
          <ul class="nav wtf-menu">
            ...
            <li class="parent">
              ...
              <ul class="submenu">
                <li class="parent">
                  <a href="mobil-hizmet.php">Mobil Hizmetler</a>
                  <!-- <i class="icon-chevron-small-right"></i>  -->
                  <!-- <ul class="submenu">
                                    <li> <a href="gallery-simple-two.html">.......</a> </li>
