...
if($name and $phone){ //Form'dan bütün değerler geliyorsa mail gönderme işlemini başlatıyoruz.
    ...
    Konu: $subject <br>
    Mesaj: $message <br>
    Bu mail: https://healthtrack.com.tr/ adresinden gelmiştir.
    ";
    ...
    $mail->SetFrom($mail->Username, ' Healthtrack  ');
    $mail->AddAddress("$MailKimeGidecek", 'Healthtrack'); //Mailin Gideceği Adres ve Alıcı Adı
...
<script>
  setTimeout(function(){
  window.location = "https://healthtrack.com.tr/";
}, 1000);
</script>